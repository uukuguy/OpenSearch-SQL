...
AK='sk-ant-oat01-6a40bf36ee9996679e31acdcb44cb65de9d2068dae3bffdcba07a93e24d3207f' # set your ak in src/llm/model.py CURSOR API
...
PYTHONPATH=$PWD/src python3 ./src/main.py --data_mode ${data_mode} --db_root_path ${db_root_path}\
